...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { output_file: @artwork.output_file, source_file: @artwork.source_file, status: @artwork.status, style_file: @artwork.style_file } }
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { output_file: @artwork.output_file, source_file: @artwork.source_file, status: @artwork.status, style_file: @artwork.style_file } }
